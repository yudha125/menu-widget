            ...
            <div class="group-widget">
                ...
                <a href="https://api.whatsapp.com/send/?phone=6285210390096&text&type=phone_number&app_absent=0" class="link-tombol-widget">
                    <div class="whatsapp-button widget-tombol">
                        <img src="https://yudha125.github.io/menu-widget/Image/wa2.webp" alt="Whatsapp NetTvPoker" width="40" height="40">
                    </div>
                </a>
                <a href="https://pola.rtp-nettvpkr.cyou/" class="link-tombol-widget">
                    <div class="rtp-button widget-tombol">
                        <img src="https://yudha125.github.io/menu-widget/Image/rtp2.webp" alt="RTP NetTvPoker" width="40" height="40">
                    </div>
                </a>
                <a href="https://www.gameiosapk.com/android.php" class="link-tombol-widget" id="tombolAndroid">
                    <div class="android-button widget-tombol">
                        <img src="https://yudha125.github.io/menu-widget/Image/android.webp" alt="Download Apk NetTvPoker" width="40" height="40">
                    </div>
                </a>
                <a href="https://www.gameiosapk.com/iphone.php" class="link-tombol-widget" id="tombolIOS">
                    <div class="ios-button widget-tombol">
                        <img src="https://yudha125.github.io/menu-widget/Image/apple.webp" alt="Download IOS NetTvPoker" width="40" height="40">
                    </div>
                </a>
                
            </div>
        </div>
        <img src="https://yudha125.github.io/menu-widget/Image/nettvpokerfinal.webp" alt="Logo NetTvPoker" class="hoki-logo" id="lghok">
        <img src="https://yudha125.github.io/menu-widget/Image/tunjuk.webp" alt="Tunjuk NetTvPoker" class="tunjuk" id="tunjukgif">
