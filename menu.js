function addDynamicContent(url1, url2, url3, url4) {
    ...
    if (
        ...
        (function () {
            ...
            imgA.src = 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/SAVE.gif';
            imgA.alt = 'Click Me';
            imgA.id = 'clickImage';
            ...
            img1.src = 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/FORANDROID.jpg';
            img1.alt = 'image1';
            ...
            img2.src = 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/FOR_IOS.jpg';
            img2.alt = 'image2';
    ...
    if (url2 === 'https://pro.rtpyk-69.beauty/') {
        mainImage.src = 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/YUK69A.gif';
        ...
        mainImage.src = 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/HOKI.gif';
        mainImage.style.height = '90px';
        ...
        mainImage.src = 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/METROWIN88.gif';
        ...
        mainImage.src = 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/TVONE.gif';
        mainImage.style.width = '90px';
        ...
        mainImage.src = 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/SCTV.gif';
        mainImage.style.width = '90px';
        mainImage.style.maxHeight = '70px';
        mainImage.style.bottom = '30px';
        mainImage.style.left = '15px';
        ...
        mainImage.src = 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/METROTVPOKER.gif';
        mainImage.style.width = '90px';
        ...
        mainImage.src = 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/NETTV.gif';
        mainImage.style.width = '90px';
        mainImage.style.maxHeight = '80px';
        ...
        mainImage.src = 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/POKERHOKIBET88.gif';
        mainImage.style.width = '90px';
        mainImage.style.maxHeight = '80px';
        mainImage.style.bottom = '25px';
        mainImage.style.left = '15px';
    ...
    const actions = [
        { href: url1, img: 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/tele.gif' },
        { href: url2, img: 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/rtp.gif' },
        { href: url3, img: 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/wa.gif' },
        { href: url4, img: 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/fb.gif' }
    ];
    ...
    actionButton.addEventListener('click', () => {
        ...
        mainImage.src = isActive
            ...
            : (() => {
                if (url2 === 'https://pro.rtpyk-69.beauty/') {
                    return 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/YUK69A.gif';
                } else if (url2 === 'https://t.ly/rtp-hoki777/') {
                    return 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/HOKI.gif';
                } else if (url2 === 'https://es.pola-metrowin88.site/') {
                    return 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/METROWIN88.gif';
                } else if (url2 === 'https://t.ly/rtp-squad777') {
                    return 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/SQUAD777.gif';
                } else if (url2 === 'https://pola.rtp-tvonepkr.shop') {
                    return 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/TVONE.gif';
                } else if (url2 === 'https://es.rtp-sctvpkr.cam/') {
                    return 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/SCTV.gif';
                } else if (url2 === 'https://id.rtp-metropkr.online/') {
                    return 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/METROTVPOKER.gif';
                } else if (url2 === 'https://pola.rtp-nettvpkr.cyou/') {
                    return 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/NETTV.gif';
                } else if (url2 === 'https://pro.rtp-pkhk.biz/') {
                    return 'https://raw.githubusercontent.com/yudha125/widgetMenu/images/images/POKERHOKIBET88.gif';
                }
            })();
    });
